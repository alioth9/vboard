...
# vb_layout = os.environ['VBOARD_LAYOUT']
vb_layout = 'vboard_x'
# print(vb_layout)

# if vb_layout == 'vboard_X':
# import self.CONFIG_DIR = os.path.expanduser("~/.config/vboard")
# else
...
if vb_layout == "vboard_x":
    key_mapping = {uinput.KEY_ESC: "Esc", uinput.KEY_1: "1", uinput.KEY_2: "2", uinput.KEY_3: "3", uinput.KEY_4: "4", uinput.KEY_5: "5", uinput.KEY_6: "6",
	           ...
	           uinput.KEY_BACKSPACE: "Bsp", uinput.KEY_TAB: "Tab",uinput.KEY_LEFTBRACE: "[", uinput.KEY_RIGHTBRACE: "]",
	           uinput.KEY_Q: "q", uinput.KEY_W: "w", uinput.KEY_E: "e", uinput.KEY_R: "r", uinput.KEY_Y: "y",
	           uinput.KEY_T: "t", uinput.KEY_U: "u", uinput.KEY_I: "i", uinput.KEY_O: "o", uinput.KEY_P: "p", uinput.KEY_N: "n", uinput.KEY_M: "m",
	           uinput.KEY_LEFTCTRL: "Ctrl_L", uinput.KEY_A: "a", uinput.KEY_S: "s", uinput.KEY_D: "d", uinput.KEY_F: "f", uinput.KEY_G: "g",
	           uinput.KEY_H: "h", uinput.KEY_J: "j", uinput.KEY_K: "k", uinput.KEY_L: "l",
	           uinput.KEY_Z: "z", uinput.KEY_X: "x", uinput.KEY_C: "c", uinput.KEY_V: "v", uinput.KEY_B: "b",
	           uinput.KEY_SEMICOLON: ";", uinput.KEY_GRAVE: "`", uinput.KEY_SEMICOLON: "é", uinput.KEY_GRAVE: "è",
	           uinput.KEY_COMMA: ",", uinput.KEY_DOT: ".", uinput.KEY_APOSTROPHE: "'",uinput.KEY_SLASH: "/", uinput.KEY_BACKSLASH: "\\", uinput.KEY_BACKSLASH: "*",
	           uinput.KEY_KPENTER: "Enter", uinput.KEY_SPACE: "Space", uinput.KEY_ENTER: "Enter",
	           ...
	           uinput.KEY_DELETE: "Del", uinput.KEY_END: "End", uinput.KEY_PAGEDOWN: "PgDwn", uinput.KEY_PAGEUP: "PgUp",
	           uinput.KEY_RIGHT: "→", uinput.KEY_LEFT: "←", uinput.KEY_DOWN: "↓", uinput.KEY_UP: "↑", uinput.KEY_NUMLOCK: "NumLock",
	           uinput.KEY_LEFTSHIFT: "Shift_L", uinput.KEY_RIGHTSHIFT: "Shift_R", uinput.KEY_CAPSLOCK: "CapsLock",  uinput.KEY_LEFTALT: "Alt_L", uinput.KEY_RIGHTALT: "AltGr",
	           uinput.KEY_RIGHTCTRL: "Ctrl_R", uinput.KEY_LEFTMETA:"Super_L", uinput.KEY_RIGHTMETA:"Super_R"}
else:
    key_mapping = {uinput.KEY_ESC: "Esc", uinput.KEY_1: "1", uinput.KEY_2: "2", uinput.KEY_3: "3", uinput.KEY_4: "4", uinput.KEY_5: "5", uinput.KEY_6: "6",
                   uinput.KEY_7: "7", uinput.KEY_8: "8", uinput.KEY_9: "9", uinput.KEY_0: "0", uinput.KEY_MINUS: "-", uinput.KEY_EQUAL: "=",
                   uinput.KEY_BACKSPACE: "Bsp", uinput.KEY_TAB: "Tab", uinput.KEY_Q: "Q", uinput.KEY_W: "W", uinput.KEY_E: "E", uinput.KEY_R: "R",
                   ...
                   uinput.KEY_F7: "F7", uinput.KEY_F8: "F8", uinput.KEY_F9: "F9", uinput.KEY_F10: "F10", uinput.KEY_F11: "F11", uinput.KEY_F12: "F12",
                   uinput.KEY_SCROLLLOCK: "ScrollLock", uinput.KEY_PAUSE: "Pause", uinput.KEY_INSERT: "Insert", uinput.KEY_HOME: "Home",
                   uinput.KEY_PAGEUP: "PgUp", uinput.KEY_DELETE: "Delete", uinput.KEY_END: "End", uinput.KEY_PAGEDOWN: "PgDwn",
                   uinput.KEY_RIGHT: "→", uinput.KEY_LEFT: "←", uinput.KEY_DOWN: "↓", uinput.KEY_UP: "↑", uinput.KEY_NUMLOCK: "NumLock",
                   uinput.KEY_RIGHTCTRL: "Ctrl_R", uinput.KEY_LEFTMETA:"Super_L", uinput.KEY_RIGHTMETA:"Super_R"}
# print(type(key_mapping))

key_labels = {uinput.KEY_ESC: "ESC", uinput.KEY_1: "1", uinput.KEY_2: "2", uinput.KEY_3: "3", uinput.KEY_4: "4", uinput.KEY_5: "5", uinput.KEY_6: "6",
	       uinput.KEY_7: "7", uinput.KEY_8: "8", uinput.KEY_9: "9", uinput.KEY_0: "0", uinput.KEY_MINUS: "-", uinput.KEY_EQUAL: "=",
	       uinput.KEY_BACKSPACE: "Bsp", uinput.KEY_TAB: "Tab",uinput.KEY_LEFTBRACE: "[", uinput.KEY_RIGHTBRACE: "]",
	       uinput.KEY_Q: "q", uinput.KEY_W: "w", uinput.KEY_E: "e", uinput.KEY_R: "r", uinput.KEY_Y: "y",
	       uinput.KEY_T: "t", uinput.KEY_U: "u", uinput.KEY_I: "i", uinput.KEY_O: "o", uinput.KEY_P: "p", uinput.KEY_N: "n", uinput.KEY_M: "m",
...
class VirtualKeyboard(Gtk.Window):
    def __init__(self):
        ...
        # print(self)
        self.LAYOUTS_DIR = os.path.join(self.CONFIG_DIR, "layouts")
        # print(self.LAYOUTS_DIR)
        # global vb_layout
        # self.LAYOUTS_FILE = os.path.join(self.LAYOUTS_DIR, vb_layout + ".py")
        # print(self.LAYOUTS_FILE)

        # if self.LAYOUTS_FILE != '':
        #     print(self.LAYOUTS_FILE)
        #     # import self.LAYOUTS_FILE
        # else:
        #     vb_layout = "qwerty"
        ...
        # vb_layout2 = self.config.get('LAYOUT' , 'layout_file')
        # print(vb_layout2)
        # key_mapping = self.config.get('LAYOUT' , 'vb_key_mapping')
        # print(type(key_mapping))
        # vb_km_rows = ''
        vb_km_rows = self.config.get('LAYOUT' , 'vb_km_rows')
        # print(type(vb_km_rows))
        
        # self.LAYOUTS_FILE = os.path.join(self.LAYOUTS_DIR, vb_layout2 + ".py")
        # if self.LAYOUTS_FILE != '':
        #     with open(self.LAYOUTS_FILE, 'r') as file:
        #         code = file.read()
        #         exec(code)
        #         # print(test)
        #         # global vb_key_mappings
        #         # key_mappings = vb_key_mappings
        #         # rows = vb_rows
        #     # import self.LAYOUTS_FILE
        # else:
        #     vb_layout = ''
        ...
        if vb_km_rows == '':
            ...
            # print(vb_km_rows)
            # we take the list of rows from vb_km_rows defined in settings
            # ast is to convert string to list
            rows = ast.literal_eval(vb_km_rows)
            # print(type(rows))
